"""Native cognis-connect emit for trustgate — forward findings to any platform.

Maps trustgate's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    trustgate ... --format json | trustgate-emit --to stix
    trustgate-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
